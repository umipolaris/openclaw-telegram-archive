      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3 lg:grid-cols-6">
        {metricCards.map((card) => (
          <button
            ...
            className="rounded-lg border border-stone-200 bg-panel p-4 text-left shadow-panel transition hover:border-stone-300"
          >
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
        <article className="rounded-lg border border-stone-200 bg-panel p-4 shadow-panel">
          ...
          <ul className="mt-3 space-y-2 text-sm">
            {data.categories.length === 0 ? <li className="text-stone-500">데이터 없음</li> : null}
        ...
        <article className="rounded-lg border border-stone-200 bg-panel p-4 shadow-panel">
          ...
          <ul className="mt-3 space-y-2 text-sm">
            {data.failed_error_codes.length === 0 ? <li className="text-stone-500">실패 코드 없음</li> : null}
            {data.failed_error_codes.map((item) => (
        ...
        <article className="rounded-lg border border-stone-200 bg-panel p-4 shadow-panel">
          ...
          <ul className="mt-3 space-y-2 text-sm">
            {data.recent_documents.length === 0 ? <li className="text-stone-500">데이터 없음</li> : null}
