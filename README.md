...
- 운영: 문서 편집·버전 히스토리·코멘트, 검토 큐, 규칙 버전/백필, 감사 로그
- 시각화: 아카이브/타임라인/고급검색/마인드맵으로 탐색
- 안정성: 관리자 백업/복구(업로드 복구 포함)와 복구 진행 상태 확인 지원
...
- 데이터 안정성: SHA256 기반 파일 관리, DB/첨부/설정 백업·복구, 업로드 복구, 진행률 표시
